...
class I2CPanel :
	...
	class ReadRegisterValueListener :
		...
		"""
		def __init__(self, textBoxTuple) :
...
#		self.listener=I2CPanel.ConnectedCBCListener(self.cbcList)
		...
		verticalPanelForI2C = VerticalPanel()
		verticalPanelForI2C.add(self.mainSettings)
		verticalPanelForI2C.add(self.channelMasks)
		verticalPanelForI2C.add(self.channelTrims)
		self.mainPanel.add( verticalPanelForI2C )
